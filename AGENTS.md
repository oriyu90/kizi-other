...
- Android現行配布版は `v0.2.0`、対象commitは `6a05e7edd38735d57b1ec1f6f0b69acd91ff1f3a`、Releaseは `https://github.com/oriyu90/kizi-publisher-android/releases/tag/v0.2.0` とする。APK SHA-256は `bbd0ee808141a254077a7bf8af2df06fa23ee09078afe25e6ef8d9d3311935bd`、AAB SHA-256は `49948777f479ec0fe7cdf1c540886dc567d44408d26d50cc756961c85e13128b`、署名証明書SHA-256は `29bc33a0240eb1f17dd5fb4748c1034a0b8663405a9c341ba192c520624a660f` である。署名は個人配布用の自己署名であり、Google Play App Signingは未使用である。
...
- Android Publisher v0.2.0は、本文翻訳と同じ5言語の`title`、`subtitle`、`description`をcandidate payload schema 2で生成し、版カタログの`translations`へ追加する。5言語と4fieldの完全性をvalidated ref作成前に検証し、schema 1はv0.1.1後方互換用にのみ受け付ける。AI入力Markdownのschemaと通常入力項目は変更しない。
